...
# Aliases
	alias pacadd="sudo pacman --needed --noconfirm -Sy"
	alias pacrm="sudo pacman -Rs"
	alias pacSs="pacman -Ss"
	alias pacup="sudo pacman -Syu"

	alias rr="bash ~/uni/runner"
	alias todo="calcurse -D ~/git/.dotfiles/.config/calcurse"
	alias updb="sudo updatedb"
	alias news="newsboat -u ~/git/.dotfiles/.config/newsboat/urls"
	alias vim="nvim"
